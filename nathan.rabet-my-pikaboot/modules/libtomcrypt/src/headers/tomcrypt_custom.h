...
#if (defined(malloc) || defined(realloc) || defined(calloc) || defined(free) || defined(memset) || defined(memcpy) ||  \
     defined(memcmp) || defined(strcmp) || defined(strlen) || defined(strncpy) || defined(clock) || defined(qsort)) && \
